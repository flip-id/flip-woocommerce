...
class FlipForBusiness_Logger {
    ...
    * @return void
    */
   public static function log( $message, $log_file_name, $plugin_id = 'flip', $start_time = null, $end_time = null ) {
      if ( ! class_exists( 'WC_Logger' ) ) {
         return;
      }

      if ( apply_filters( 'wc_flip_logging', true, $message ) ) {
         ...
         if ( ! is_null( $start_time ) ) {
            ...
            $log_entry  = "\n" . '====Flip Plugin Version: ' . FLIP_PLUGIN_VERSION . '====' . "\n";
